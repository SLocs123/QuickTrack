...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                distances = []
                for item in detList:
                    distances.append(distance(item[:4], names[2], imageHeight))

                if save_det:
                    detWhole.append([detList, frame])
                    distWhole.append([distances, frame])
    ...
    if save_det:
        ...
        with open("det.pickle", 'wb') as f:
            pickle.dump(detWhole, f)
        with open("dist.pickle", 'wb') as f:
            pickle.dump(distWhole, f)
